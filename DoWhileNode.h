...
class DoWhileNode : public AbstractSyntaxTreeNode {
private:
	ReferencePtr<AbstractSyntaxTreeNode> m_condition;
	ReferencePtr<AbstractSyntaxTreeNode> m_stmt;
public:
	DoWhileNode(const ReferencePtr<AbstractSyntaxTreeNode>& cond, const ReferencePtr<AbstractSyntaxTreeNode>& stmt) : AbstractSyntaxTreeNode{ TreeNodeType::DO_WHILE }, m_condition{ cond }, m_stmt{ stmt } {
