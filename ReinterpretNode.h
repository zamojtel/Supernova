...
class ReinterpretNode :public AbstractSyntaxTreeNode {
private:
	ReferencePtr<DataTypeNode> m_data_type_node;
	ReferencePtr<AbstractSyntaxTreeNode> m_expr_node;
public:
	ReinterpretNode(const ReferencePtr<DataTypeNode>& c_t, const ReferencePtr<AbstractSyntaxTreeNode>& e) :AbstractSyntaxTreeNode{ TreeNodeType::REINTERPRET_CAST }, m_data_type_node{ c_t }, m_expr_node{e} {
