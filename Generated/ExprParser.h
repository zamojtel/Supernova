...
public:
  ...
  enum {
    RuleProg = 0, RuleExpr = 1, RuleInteger = 2
  };
  ...
  public:
    ExprParser::ExprContext *exprContext = nullptr;
  ...
  public:
    ExprParser::ExprContext *left = nullptr;
    ExprParser::IntegerContext *integerContext = nullptr;
    ExprParser::ExprContext *right = nullptr;
  ...
  class  IntegerContext : public MyContextSuperClass {
  public:
