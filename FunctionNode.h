...
private:
	...
	IRFunction* m_fn_ptr;
public:
	FunctionNode(bool in, const ReferencePtr<DataTypeNode>& dn, const ReferencePtr<IdentifierNode>& id, const ReferencePtr<ListNode<FunctionParameterNode>>& n_l, const ReferencePtr<BlockNode>& block) : AbstractSyntaxTreeNode{ TreeNodeType::FUNCTION }, m_inline{in}, m_data_type{ dn }, m_identifier{ id }, m_parameters{ n_l }, m_block{ block } {
